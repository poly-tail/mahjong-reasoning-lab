...
左ペインには候補グループ、候補枝、4軸影響、未展開の枝、例外の枝置き場を表示します。中央ペインには選択中の枝の候補確率、影響スコア、軸確信度、観測、例外、操作履歴を表示します。右ペインには `枝を切る`、`枝を弱める`、`有力枝を残す`、`枝を固定する`、`比率を固定する`、`未展開の枝に送る`、`例外の枝置き場に送る`、`読みの枝候補から追加` を表示します。
